...
exports.CorrectTypo1785483206679 = void 0;
class CorrectTypo1785483206679 {
    name = 'CorrectTypo1785483206679';
    async up(queryRunner) {
        const typeExists = await queryRunner.query(`SELECT 1 FROM pg_type WHERE typname = 'news-fetch-log_triggeredby_enum'`);
        ...
        const constraintExists = await queryRunner.query(`SELECT 1 FROM information_schema.table_constraints WHERE constraint_name = 'FK_51fe272002e1ff7f853a29ec3b7'`);
...
exports.CorrectTypo1785483206679 = CorrectTypo1785483206679;

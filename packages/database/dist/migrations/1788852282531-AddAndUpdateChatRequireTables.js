...
exports.AddAndUpdateChatRequireTables1788852282531 = void 0;
class AddAndUpdateChatRequireTables1788852282531 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "rooms" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(100) NOT NULL, "description" character varying(500), "owner_id" uuid NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_0368a2d7c215f2d0458a54933f2" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_MESSAGE_SENDER_ID" ON "message"  ("sender_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_MESSAGE_ROOM_CREATED_AT" ON "message"  ("room_id", "created_at") `);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_MESSAGE_ROOM_CREATED_AT"`);
...
exports.AddAndUpdateChatRequireTables1788852282531 = AddAndUpdateChatRequireTables1788852282531;
